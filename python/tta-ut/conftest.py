...
SKIP_TESTS = [
    ...
    "test_advance_ptr.py::test_advance_with_boundary_check[shape0-float32]",
    "test_arange.py::test_case[param_list1]",
    "test_arange.py::test_case[param_list2]",
    "test_arange.py::test_case_access[param_list1]",
    "test_arange.py::test_case_access[param_list2]",
]
