...
// CHECK:           %[[LOAD_0:.*]] = tt.load %[[MAKE_GATHER_SCATTER_TPTR_0]] {tta.fallback, tta.fallback_reason = "address_analysis_failed"} : !tt.ptr<tensor<4x4xf32>>
// CHECK:           %[[MAKE_ADDR_0:.*]] = tta.make_addr %[[ARG1]] to sizes: [4, 4], strides: [4, 1], offsets: [0, 0], shape: [0, 0], order: [] : <f32> to !tta.addr<f32, 2, 1>
