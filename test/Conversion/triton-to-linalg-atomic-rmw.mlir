// RUN: triton-xyz-opt --triton-to-linalg %s | FileCheck %s
...
// CHECK:           %[[GENERIC_1:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_0]], #[[$ATTR_0]], #[[$ATTR_0]]], iterator_types = ["parallel"]} ins(%[[GENERIC_0]], %[[FILL_0]] : tensor<4xi32>, tensor<4xi32>) outs(%[[EMPTY_1]] : tensor<4xi1>) {
...
// CHECK:             %[[GENERIC_2:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_0]], #[[$ATTR_0]], #[[$ATTR_0]]], iterator_types = ["parallel"]} ins(%[[GENERIC_0]], %[[FILL_2]] : tensor<4xi32>, tensor<4xi32>) outs(%[[GENERIC_0]] : tensor<4xi32>) {
...
// CHECK:               scf.yield %[[INSERT_0]] : tensor<4xi32>
// CHECK:             }
// CHECK:             %[[GENERIC_3:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_0]], #[[$ATTR_0]], #[[$ATTR_0]]], iterator_types = ["parallel"]} ins(%[[VAL_5]], %[[FOR_1]] : tensor<4xi32>, tensor<4xi32>) outs(%[[VAL_5]] : tensor<4xi32>) {
